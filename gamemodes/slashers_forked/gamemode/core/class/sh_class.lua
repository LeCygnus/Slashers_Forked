...
GM.CLASS.Survivors[CLASS_SURV_SPORTS].runspeed = 270
GM.CLASS.Survivors[CLASS_SURV_SPORTS].life = 120
GM.CLASS.Survivors[CLASS_SURV_SPORTS].stamina = 240
...
GM.CLASS.Survivors[CLASS_SURV_POPULAR].runspeed = 270
...
GM.CLASS.Survivors[CLASS_SURV_NERD].runspeed = 270
GM.CLASS.Survivors[CLASS_SURV_NERD].life = 100
GM.CLASS.Survivors[CLASS_SURV_NERD].stamina = 115
...
GM.CLASS.Survivors[CLASS_SURV_FAT].walkspeed = 120
GM.CLASS.Survivors[CLASS_SURV_FAT].runspeed = 320
GM.CLASS.Survivors[CLASS_SURV_FAT].life = 1800
GM.CLASS.Survivors[CLASS_SURV_FAT].stamina = 90
...
GM.CLASS.Survivors[CLASS_SURV_SHY].runspeed = 270
...
GM.CLASS.Survivors[CLASS_SURV_JUNKY].runspeed = 270
...
GM.CLASS.Survivors[CLASS_SURV_EMO].runspeed = 270
...
GM.CLASS.Survivors[CLASS_SURV_EMO].weapons = {"stun_gun"}
if CLIENT then
...
GM.CLASS.Survivors[CLASS_SURV_BLACK].runspeed = 270
...
GM.CLASS.Survivors[CLASS_SURV_BLACK].keysNumber = 4
if CLIENT then
...
GM.CLASS.Survivors[CLASS_SURV_SHERIF].runspeed = 270
